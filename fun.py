...
def get_text_messages(bot, cur_user, message):
    ...
    if ms_text == "Пришли собачку":
        bot.send_photo(chat_id, photo=get_dogURL(), caption="Вот и собачка!")
        bot.send_sticker(message.chat.id, "CAACAgIAAxkBAAEE559imejhfzoy_DylXPoY5Bkgqfj1bgAC7w4AAnAuEUv1HHxo5fyJtSQE")

    elif ms_text == "Пришли котика":
        bot.send_photo(chat_id, photo=get_cat(), caption="Вот и кошечка!")
        bot.send_sticker(message.chat.id, "CAACAgIAAxkBAAEE5ihimW3e10bJGXkMPwaGrIkUQdHr2QACOg8AAtjZEUtJhIteOm8PuiQE")

    elif ms_text == "Прислать анекдот":
        bot.send_message(chat_id, text=get_anekdot())
        bot.send_sticker(message.chat.id, "CAACAgIAAxkBAAEE5hRimTzBD704QIBP-hX4w-HQkZ_hZwACKAADBL0eGZtdOB_GWG90JAQ")
